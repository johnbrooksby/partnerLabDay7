...
favoriteThings.car = "Ferrari F50";
favoriteThings.show = "Cosby";
...
console.log (totalPopulation({utah: 2, california: 5, texas: 3, arizona: 1}));
...
let cat1 = new Cat("Steven", "37", "black");
...
let wiz1 = new Wizard("John", 41, "Imperio");
wiz1.castSpell();
...
let phone1 = new Phone("Nokia", "N93", 8, "grey", 200);
let phone2 = new Phone("Motorola", "RAZR", 8, "grey", 250);
let phone3 = new Phone("LG", "K51", 16, "black", 200);
...
let myFirstVehicle = new Vehicle(2, "red", 1000);
...
const myFirstMotorcycle = new Motorcycle(2, "black", 300000, "Honda", "Very");
...
let myFirstBoat = new Boat(35, "white", 52489, "The Jolly Ned", "yacht");
